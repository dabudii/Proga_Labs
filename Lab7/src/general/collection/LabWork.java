...
public class LabWork implements Comparable<LabWork>{
     ...
     */
    public LabWork(long id, String name, Coordinates coordinates, java.time.LocalDateTime creationDate, Float minimalPoint, Difficulty difficulty, Discipline discipline, Profile owner){
        this.id = id;
        this.name = name;
     ...
     * @param discipline is the discipline of the lab.
     */
    public LabWork(String name, Coordinates coordinates, java.time.LocalDateTime creationDate, Float minimalPoint, Difficulty difficulty, Discipline discipline, Profile owner){
        this.id = idAuto++;
        this.name = name;
        this.coordinates = coordinates;
        this.creationDate = creationDate;
