...
public class UserHandler {
     ...
     */
    public Request handle(ResponseCode serverResponseCode, Profile profile) {
        String userInput;
        String[] userCommand;
        ...
        try {
            ...
            try {
                ...
                switch (processingCode) {
                    case OBJECT:
                        Laba labaAdd = generateLabWork();
                        return new Request(userCommand[0], userCommand[1], labaAdd, profile);
                    case UPDATE_OBJECT:
                        Laba labaUpdate = generateLabWorkUpdate();
                        return new Request(userCommand[0], userCommand[1], labaUpdate, profile);
                    case SCRIPT:
        ...
        return new Request(userCommand[0], userCommand[1], null, profile);
    }
